...
<body>          
<form action="DatosPersonales" method="POST" class="my-login-validation" id="my-login-validation" novalidate="">
                <div class="row">
                    <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" maxlength="15" minlength="2" pattern="[a-zA-Z ]{2,20}" name="textNombre" placeholder="Ingrese su nombre" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="invalid-feedback">
                                                ...
                                                <div class="invalid-feedback">
                                                Minimo de 7 caracteres
                                                </div>
                                                <div class="invalid-feedback">
                                                Màximo de 10 carcteres
                                                </div>
                                            </div>
