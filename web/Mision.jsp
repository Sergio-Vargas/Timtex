<%-- 
    Document   : Mision
    Created on : 27-jun-2021, 13:51:13
    Author     : sergio saenz
--%>
...
<br>
    <center>
        <div class="Mision">    
            <br>
            <h1 class="Tmision">Misión</h1>
            <br><br><br>
            <p class="Mparrafo">
                Fabricar y comercializar productos de confección de alta calidad para los mercados que atiende la empresa, 
                a través de capital humano calificado, comprometido y desarrollado con los valores éticos, tecnologías y prácticas
                que generen confianza de nuestros clientes, rentabilidad, 
                sustentabilidad y desarrollo creciente de la empresa. motivación y compromiso de nuestro recurso humano.
            </p>
        </div>  
    </center>
    <br><br>
...
<footer class="footer">
	...
	<div class="redes">
		<p>Redes sociales</p>
                <a href="https://www.facebook.com/condifal/"><img class="img-redes" src="Imagenes/facebook.png" style="height:80px;"></a>
