    ...
    <body>
     ...
     <center>
        ...
        <div class="page-header mt-0 shadow p-3">
                                  ...
                                  <a href="inactivoUsuario.jsp"><button class="btn btn-primary">Inactivos</button></a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form method="post" action="Usuario">
                                            ...
                                            <input type="hidden" name="textEstado" value="Inactivo" class="form-control" required>
